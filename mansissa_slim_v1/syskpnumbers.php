 ...
 * @since 11.08.2018
 */
$app->get("/pkKpnumbersDdList_syskpnumbers/", function () use ($app ) {
    $stripper = $app->getServiceManager()->get('filterChainerCustom');
    $stripChainerFactory = new \Services\Filter\Helper\FilterChainerFactory(); 
    $BLL = $app->getBLLManager()->get('sysKpnumbersBLL');
    ...
    if(!isset($headerParams['X-Public'])) throw new Exception ('rest api "pkKpnumbersDdList_syskpnumbers" end point, X-Public variable not found');
    ...
    $resCombobox = $BLL->kpnumbersDdList(array(                                   
 ...
 * @since 15-08-2018
 */
$app->get("/pkFillKpnumbersGridx_syskpnumbers/", function () use ($app ) {
    $stripper = $app->getServiceManager()->get('filterChainerCustom');
    $stripChainerFactory = new \Services\Filter\Helper\FilterChainerFactory();
    $BLL = $app->getBLLManager()->get('sysKpnumbersBLL');
    $headerParams = $app->request()->headers();
    if (!isset($headerParams['X-Public']))
        throw new Exception('rest api "pkFillKpnumbersGridx_syskpnumbers" end point, X-Public variable not found');
    $pk = $headerParams['X-Public'];
    ...
    $resDataGrid = $BLL->fillKpnumbersGridx(array(
        'language_code' => $vLanguageCode,
        'LanguageID' => $lid,
        'page' => $vPage,
        'rows' => $vRows,
    ...
    $resTotalRowCount = $BLL->fillKpnumbersGridxRtl(array(
        'language_code' => $vLanguageCode, 
        'LanguageID' => $lid,
 ...
 * @since 15-08-2018
 */
$app->get("/fillAccBodyDeffGridx_syskpnumbers/", function () use ($app ) {
    $stripper = $app->getServiceManager()->get('filterChainerCustom');
    $stripChainerFactory = new \Services\Filter\Helper\FilterChainerFactory();
    $BLL = $app->getBLLManager()->get('sysKpnumbersBLL');
   /* $headerParams = $app->request()->headers();
    if (!isset($headerParams['X-Public']))
        throw new Exception('rest api "fillAccBodyDeffGridx_syskpnumbers" end point, X-Public variable not found');
    $pk = $headerParams['X-Public'];
*/
    $vLanguageCode = 'en';
    if (isset($_GET['language_code'])) {
 ...
 * @since 15-08-2018
 */
$app->get("/pkUpdateMakeActiveOrPassive_syskpnumbers/", function () use ($app ) {
 ...
 * @since 15-08-2018
 */ 
$app->get("/pkInsertAct_syskpnumbers/", function () use ($app ) {
    $stripper = $app->getServiceManager()->get('filterChainerCustom');
    $stripChainerFactory = new \Services\Filter\Helper\FilterChainerFactory(); 
    $BLL = $app->getBLLManager()->get('sysKpnumbersBLL');  
    $headerParams = $app->request()->headers();
    if(!isset($headerParams['X-Public'])) throw new Exception ('rest api "pkInsertAct_syskpnumbers" end point, X-Public variable not found');    
     $pk =  $headerParams['X-Public'];
 ...
 * @since 15-08-2018
 */ 
$app->get("/pkUpdateAct_syskpnumbers/", function () use ($app ) {
    $stripper = $app->getServiceManager()->get('filterChainerCustom');
    $stripChainerFactory = new \Services\Filter\Helper\FilterChainerFactory(); 
    $BLL = $app->getBLLManager()->get('sysKpnumbersBLL');  
    $headerParams = $app->request()->headers();
    if(!isset($headerParams['X-Public'])) throw new Exception ('rest api "pkUpdateAct_syskpnumbers" end point, X-Public variable not found');    
    $pk = $headerParams['X-Public'];
 ...
 * @since 15-08-2018
 */
$app->get("/pkDeletedAct_syskpnumbers/", function () use ($app ) {
    $stripper = $app->getServiceManager()->get('filterChainerCustom');
    $stripChainerFactory = new \Services\Filter\Helper\FilterChainerFactory();    
    $BLL = $app->getBLLManager()->get('sysKpnumbersBLL');   
    $headerParams = $app->request()->headers();

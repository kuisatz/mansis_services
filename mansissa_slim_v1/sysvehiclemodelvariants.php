 ...
 * @since 11.08.2018
 */
$app->get("/pkVehicleModelVariantsDdList_sysvehiclemodelvariants/", function () use ($app ) {
    $stripper = $app->getServiceManager()->get('filterChainerCustom');
    $stripChainerFactory = new \Services\Filter\Helper\FilterChainerFactory(); 
    $BLL = $app->getBLLManager()->get('sysVehicleModelVariantsBLL');
    ...
    if(!isset($headerParams['X-Public'])) throw new Exception ('rest api "pkVehicleModelVariantsDdList_sysvehiclemodelvariants" end point, X-Public variable not found');
    ...
    $resCombobox = $BLL->vehicleModelVariantsDdList(array(                                   
 ...
 * @since 15-08-2018
 */
$app->get("/pkFillAccBodyDeffGridx_sysvehiclemodelvariants/", function () use ($app ) {
    $stripper = $app->getServiceManager()->get('filterChainerCustom');
    $stripChainerFactory = new \Services\Filter\Helper\FilterChainerFactory();
    $BLL = $app->getBLLManager()->get('sysVehicleModelVariantsBLL');
    $headerParams = $app->request()->headers();
    if (!isset($headerParams['X-Public']))
        throw new Exception('rest api "pkFillAccBodyDeffGridx_sysvehiclemodelvariants" end point, X-Public variable not found');
    $pk = $headerParams['X-Public'];
 ...
 * @since 15-08-2018
 */
$app->get("/fillAccBodyDeffGridx_sysvehiclemodelvariants/", function () use ($app ) {
    $stripper = $app->getServiceManager()->get('filterChainerCustom');
    $stripChainerFactory = new \Services\Filter\Helper\FilterChainerFactory();
    $BLL = $app->getBLLManager()->get('sysVehicleModelVariantsBLL');
   /* $headerParams = $app->request()->headers();
    if (!isset($headerParams['X-Public']))
        throw new Exception('rest api "fillAccBodyDeffGridx_sysvehiclemodelvariants" end point, X-Public variable not found');
    $pk = $headerParams['X-Public'];
*/
    $vLanguageCode = 'en';
    if (isset($_GET['language_code'])) {
 ...
 * @since 15-08-2018
 */
$app->get("/pkUpdateMakeActiveOrPassive_sysvehiclemodelvariants/", function () use ($app ) {
 ...
 * @since 15-08-2018
 */ 
$app->get("/pkInsertAct_sysvehiclemodelvariants/", function () use ($app ) {
    $stripper = $app->getServiceManager()->get('filterChainerCustom');
    $stripChainerFactory = new \Services\Filter\Helper\FilterChainerFactory(); 
    $BLL = $app->getBLLManager()->get('sysVehicleModelVariantsBLL');  
    $headerParams = $app->request()->headers();
    if(!isset($headerParams['X-Public'])) throw new Exception ('rest api "pkInsertAct_sysvehiclemodelvariants" end point, X-Public variable not found');    
     $pk =  $headerParams['X-Public'];
 ...
 * @since 15-08-2018
 */ 
$app->get("/pkUpdateAct_sysvehiclemodelvariants/", function () use ($app ) {
    $stripper = $app->getServiceManager()->get('filterChainerCustom');
    $stripChainerFactory = new \Services\Filter\Helper\FilterChainerFactory(); 
    $BLL = $app->getBLLManager()->get('sysVehicleModelVariantsBLL');  
    $headerParams = $app->request()->headers();
    if(!isset($headerParams['X-Public'])) throw new Exception ('rest api "pkUpdateAct_sysvehiclemodelvariants" end point, X-Public variable not found');    
    $pk = $headerParams['X-Public'];
 ...
 * @since 15-08-2018
 */
$app->get("/pkDeletedAct_sysvehiclemodelvariants/", function () use ($app ) {
    $stripper = $app->getServiceManager()->get('filterChainerCustom');
    $stripChainerFactory = new \Services\Filter\Helper\FilterChainerFactory();    
    $BLL = $app->getBLLManager()->get('sysVehicleModelVariantsBLL');   
    $headerParams = $app->request()->headers();

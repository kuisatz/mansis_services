 ...
 * @since 30.07.2018                       
 */ 
class SysVehicleGroupTypes extends \DAL\DalSlim {

    /**
     * @author Okan CIRAN    
     * @ sys_vehicle_group_types tablosundan parametre olarak  gelen id kaydını siler. !!
    ...
    /**
     * @author Okan CIRAN
     * @ sys_vehicle_group_types tablosundaki tüm kayıtları getirir.  !!
     * @version v 1.0  30.07.2018  
     * @param array $params
     * @return array
     * @throws \PDOException 
    ...
    public function getAll($params = array()) {
        try {
			...
			COALESCE(NULLIF(lx.language, ''), l.language_eng) AS language_name,			 
                ...
                LEFT JOIN sys_vehicle_group_types ax ON (ax.id = a.id OR ax.language_parent_id = a.id) AND ax.deleted =0 AND ax.active =0 AND lx.id = ax.language_id
    ...
    /**
     * @author Okan CIRAN
     * @ sys_vehicle_group_types tablosuna yeni bir kayıt oluşturur.  !!
     * @version v 1.0  30.07.2018
     * @param type $params
     * @return array
     * @throws \PDOException
        ...
        try {
            ...
            if (\Utill\Dal\Helper::haveRecord($opUserId)) {
                ...
                //   echo debugPDO($sql, $params);
                    ...
                    $insertID = $pdo->lastInsertId('sys_vehicle_group_types_id_seq');
                    $errorInfo = $statement->errorInfo();  
                    if ($errorInfo[0] != "00000" && $errorInfo[1] != NULL && $errorInfo[2] != NULL)
                        throw new \PDOException($errorInfo[0]);
                    $pdo->commit();
    ...
    /**
     * @author Okan CIRAN
     * @ sys_vehicle_group_types tablosunda property_name daha önce kaydedilmiş mi ?  
    ...
    /**
     * @author Okan CIRAN
     * @ Gridi doldurmak için sys_vehicle_group_types tablosundan kayıtları döndürür !!
     * @version v 1.0  30.07.2018
    ...
    /**
     * @author Okan CIRAN
     * @ Gridi doldurmak için sys_vehicle_group_types tablosundan çekilen kayıtlarının kaç tane olduğunu döndürür   !!
     * @version v 1.0  30.07.2018
     * @param array | null $args
     * @return array
     * @throws \PDOException
    ...
    /*
     * @author Okan CIRAN
     * @ sys_vehicle_group_types tablosundan parametre olarak  gelen id kaydın aktifliğini
            ...
            if (isset($params['VehicleGroupTypesId']) && $params['VehicleGroupTypesId'] != "") {
             ...
             $sql = "       
                 SELECT                    
                    ...
                    0 AS state_type   
                FROM sys_vehicle_group_types a 
                inner join sys_vehicle_groups sv ON sv.id =a.vehicle_groups_id AND sv.deleted =0 AND sv.active =0    
                WHERE   
                    ".$addSQL."
                    a.deleted = 0 AND
                    a.active = 0   
    ...
    /** 
     * @author Okan CIRAN
     * @ arac grup tipleri tanımlarını grid formatında döndürür !! ana tablo  sys_vehicle_group_types 
     * @version v 1.0  15.08.2018
     * @param array | null $args
     * @return array
     * @throws \PDOException  
     */  
    public function fillVehicleGroupTypesGridx($params = array()) {
        try {
            ...
            if (isset($params['VehicleGroupsID']) && $params['VehicleGroupsID'] != "") {
                ...
                $addSql .="  a.vehicle_groups_id  = " . intval($vehicleGroupsID). "  AND  " ; 
            }  
                ...
                $sql = "
                   SELECT 
                    ...
                    INNER JOIN info_users u ON u.id = a.op_user_id 
                    /*----*/
		    INNER JOIN sys_vehicle_groups b ON b.act_parent_id = a.vehicle_groups_id AND b.show_it = 0  
                     /*----*/                 
    ...
    /** 
     * @author Okan CIRAN
     * @  arac grup tipleri tanımlarını grid formatında gösterilirken kaç kayıt olduğunu döndürür !! ana tablo  sys_vehicle_group_types 
     * @version v 1.0  15.08.2018
     * @param array | null $args
     * @return array
     * @throws \PDOException  
     */  
    public function fillVehicleGroupTypesGridxRtl($params = array()) {
        try {             
            $sorguStr = null;    
             $addSql = null;
            if (isset($params['filterRules'])) {
    ...
    /**
     * @author Okan CIRAN
     * @ sys_vehicle_group_types tablosundan parametre olarak  gelen id kaydını active ve show_it alanlarını 1 yapar. !!
    ...
    /**
     * @author Okan CIRAN     
     * @ sys_vehicle_group_types tablosundan parametre olarak  gelen id kaydın active veshow_it  alanını 1 yapar ve 
        ...
        try {
            ...
            if (\Utill\Dal\Helper::haveRecord($opUserId)) {
                ...
                $kontrol = $this->haveRecords(
                        array(
                            'name' => $name, 
                            'vehicle_groups_id' => $vehicleGroupId
                ));
                if (!\Utill\Dal\Helper::haveRecord($kontrol)) {
                    $sql = "
                    INSERT INTO sys_vehicle_group_types(
                    ...
                    VALUES (
                            ...
                            " . intval($opUserIdValue) . ",
                           (SELECT last_value FROM sys_vehicle_group_types_id_seq)
                                                 )   ";
                    $statement = $pdo->prepare($sql);
                    //   echo debugPDO($sql, $params);
                    $result = $statement->execute();

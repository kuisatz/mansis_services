 ...
 * @since 30.07.2018    
 */ 
class SysMonthsx extends \DAL\DalSlim {

    /**
     * @author Okan CIRAN
     * @ sys_monthsx tablosundan parametre olarak  gelen id kaydını siler. !!
    ...
    /**
     * @author Okan CIRAN
     * @ sys_monthsx tablosundaki tüm kayıtları getirir.  !!
     * @version v 1.0  30.07.2018  
     * @param array $params
     * @return array
     * @throws \PDOException 
    ...
    public function getAll($params = array()) {
        try {
			...
			COALESCE(NULLIF(lx.language, ''), l.language_eng) AS language_name,			 
                ...
                LEFT JOIN sys_monthsx ax ON (ax.id = a.id OR ax.language_parent_id = a.id) AND ax.deleted =0 AND ax.active =0 AND lx.id = ax.language_id
    ...
    /**
     * @author Okan CIRAN
     * @ sys_monthsx tablosuna yeni bir kayıt oluşturur.  !!
     * @version v 1.0  30.07.2018
     * @param type $params
     * @return array
     * @throws \PDOException
    ...
    /**
     * @author Okan CIRAN
     * @ sys_monthsx tablosunda property_name daha önce kaydedilmiş mi ?  
    ...
    /**
     * @author Okan CIRAN
     * @ Gridi doldurmak için sys_monthsx tablosundan kayıtları döndürür !!
     * @version v 1.0  30.07.2018
    ...
    /**
     * @author Okan CIRAN
     * @ Gridi doldurmak için sys_monthsx tablosundan çekilen kayıtlarının kaç tane olduğunu döndürür   !!
     * @version v 1.0  30.07.2018
     * @param array | null $args
     * @return array
     * @throws \PDOException
    ...
    /*
     * @author Okan CIRAN
     * @ sys_monthsx tablosundan parametre olarak  gelen id kaydın aktifliğini
    ...
    /** 
     * @author Okan CIRAN
     * @ ay tipleri ana grupları dropdown ya da tree ye doldurmak için sys_monthsx tablosundan kayıtları döndürür !!
        ...
        try {
            ...
            $statement = $pdo->prepare("     
                SELECT                    
                    ...
                    cast(mvalue as  character varying(10)) AS name_eng,
                    0 as parent_id,
                    a.active,
                    0 AS state_type  
                FROM sys_monthsx a   
    ...
    /** 
     * @author Okan CIRAN
     * @ ay tipleri alt grupları dropdown ya da tree ye doldurmak için sys_monthsx tablosundan kayıtları döndürür !!
     * @version v 1.0  11.08.2018
     * @param array | null $args
     * @return array
     * @throws \PDOException 
        ...
        try {
            ...
            $statement = $pdo->prepare("    
                ...
                WHERE   
                    a.deleted = 0 AND
                    a.active =0 AND
                    a.parent_id = " . intval($parentIdValue). "   
                ORDER BY  a.priority 
                                 ");
            $statement->execute();
            $result = $statement->fetchAll(\PDO::FETCH_ASSOC); 
    ...
    /** 
     * @author Okan CIRAN
     * @ Warranty ay tipleri alt grupları dropdown ya da tree ye doldurmak için sys_monthsx tablosundan kayıtları döndürür !!
     * @version v 1.0  11.08.2018
     * @param array | null $args
     * @return array
     * @throws \PDOException 
    ...
    /** 
     * @author Okan CIRAN
     * @ R&M ay tipleri alt grupları dropdown ya da tree ye doldurmak için sys_monthsx tablosundan kayıtları döndürür !!
     * @version v 1.0  11.08.2018
     * @param array | null $args
     * @return array
     * @throws \PDOException 
    ...
    /** 
     * @author Okan CIRAN
     * @ tradeback ay tipleri alt grupları dropdown ya da tree ye doldurmak için sys_monthsx tablosundan kayıtları döndürür !!
     * @version v 1.0  11.08.2018
     * @param array | null $args
     * @return array
     * @throws \PDOException 
    ...
    /** 
     * @author Okan CIRAN
     * @ ay tipleri tanımlarını grid formatında döndürür !! ana tablo  sys_monthsx 
     * @version v 1.0  20.08.2018
     * @param array | null $args 
     * @return array
     * @throws \PDOException  
     */  
    public function fillMonthsPGridx($params = array()) {
        try {
                    ...
                    if ($std['value'] != null) {
                        switch (trim($std['field'])) {
                            case 'name':
                                ...
                                $sorguStr.=" AND cast(mvalue as  character varying(10)) " . $sorguExpression . ' ';
			...
			a.parent_id,   
                    ...
                    INNER JOIN info_users u ON u.id = a.op_user_id 
                    /*----*/   
		    INNER JOIN sys_monthsx drd ON drd.act_parent_id = a.parent_id AND drd.active =0 AND drd.deleted = 0 AND drd.language_id= l.id and drd.parent_id =0 
		    LEFT JOIN sys_monthsx drdx ON (drdx.act_parent_id = drd.act_parent_id OR drdx.language_parent_id= drd.act_parent_id) AND drdx.active =0 AND drdx.deleted = 0 AND drdx.language_id =lx.id  
                    /*----*/   
    ...
    /** 
     * @author Okan CIRAN
     * @ ay tipleri tanımlarını grid formatında gösterilirken kaç kayıt olduğunu döndürür !! ana tablo sys_monthsx
     * @version v 1.0  20.08.2018
     * @param array | null $args
     * @return array
     * @throws \PDOException  
    ...
    /**
     * @author Okan CIRAN
     * @ sys_monthsx tablosundan parametre olarak  gelen id kaydını active ve show_it alanlarını 1 yapar. !!
    ...
    /**
     * @author Okan CIRAN     
     * @ sys_monthsx tablosundan parametre olarak  gelen id kaydın active veshow_it  alanını 1 yapar ve 

...
class SysVehiclesEndgroups extends \DAL\DalSlim {
    ...
    /**
     * @author Okan CIRAN
     * @ sys_vehicles_endgroups tablosundan parametre olarak  gelen id kaydını active ve show_it alanlarını 1 yapar. !!
    ...
    /**
     * @author Okan CIRAN     
     * @ sys_vehicles_endgroups tablosundan parametre olarak  gelen id kaydın active veshow_it  alanını 1 yapar ve 

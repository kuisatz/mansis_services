 ...
 * @since 30.07.2018        
 */ 
class SysSalesProvisions extends \DAL\DalSlim {

    /**
     * @author Okan CIRAN    
     * @ sys_sales_provisions tablosundan parametre olarak  gelen id kaydını siler. !!
    ...
    /**
     * @author Okan CIRAN
     * @ sys_sales_provisions tablosundaki tüm kayıtları getirir.  !!
     * @version v 1.0  30.07.2018  
     * @param array $params
     * @return array
     * @throws \PDOException 
    ...
    public function getAll($params = array()) {
        try {
			...
			COALESCE(NULLIF(lx.language, ''), l.language_eng) AS language_name,			 
                ...
                LEFT JOIN sys_sales_provisions ax ON (ax.id = a.id OR ax.language_parent_id = a.id) AND ax.deleted =0 AND ax.active =0 AND lx.id = ax.language_id
    ...
    /**
     * @author Okan CIRAN
     * @ sys_sales_provisions tablosunda property_name daha önce kaydedilmiş mi ?  
    ...
    /**
     * @author Okan CIRAN
     * @ Gridi doldurmak için sys_sales_provisions tablosundan kayıtları döndürür !!
     * @version v 1.0  30.07.2018
    ...
    /**
     * @author Okan CIRAN
     * @ Gridi doldurmak için sys_sales_provisions tablosundan çekilen kayıtlarının kaç tane olduğunu döndürür   !!
     * @version v 1.0  30.07.2018
     * @param array | null $args
     * @return array
     * @throws \PDOException
    ...
    /*
     * @author Okan CIRAN
     * @ sys_sales_provisions tablosundan parametre olarak  gelen id kaydın aktifliğini
                        ...
                        switch (trim($std['field'])) {
                            ...
                            case 'vehicle_maingroup':
                             ...
                             case 'sales_provision_name':
                                $sorguExpression = ' ILIKE \'%' . $std['value'] . '%\'  ';
                                $sorguStr.=" AND COALESCE(NULLIF(drdx.abbrevation, ''), drd.abbrevation_eng)" . $sorguExpression . ' ';

                                break; 
                             case 'kp':
                                $sorguExpression = ' ILIKE \'%' . $std['value'] . '%\' ';
                                $sorguStr.=" AND crd.name" . $sorguExpression . ' ';
    ...
    /** 
     * @author Okan CIRAN
     * @ cost(sales provison) gruplarının kp  bazlı degerlerinı grid formatında gösterilirken kaç kayıt olduğunu döndürür !! ana tablo  sys_sales_provisions 
     * @version v 1.0  20.08.2018
     * @param array | null $args
     * @return array
     * @throws \PDOException  
    ...
    /**
     * @author Okan CIRAN
     * @ sys_sales_provisions tablosundan parametre olarak  gelen id kaydını active ve show_it alanlarını 1 yapar. !!
    ...
    /**
     * @author Okan CIRAN     
     * @ sys_sales_provisions tablosundan parametre olarak  gelen id kaydın active veshow_it  alanını 1 yapar ve 

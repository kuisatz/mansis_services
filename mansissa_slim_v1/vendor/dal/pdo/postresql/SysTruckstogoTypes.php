 ...
 * @since 05.05.2016
 */
class SysTruckstogoTypes extends \DAL\DalSlim {

    /**
     * @author Okan CIRAN
     * @ sys_truckstogo_types tablosundan parametre olarak  gelen id kaydını siler. !!
    ...
    /**
     * @author Okan CIRAN
     * @ sys_truckstogo_types tablosundaki tüm kayıtları getirir.  !!
     * @version v 1.0  05.05.2016  
     * @param array $params
     * @return array
     * @throws \PDOException
    ...
    public function getAll($params = array()) {
        try {
			...
			COALESCE(NULLIF(lx.language, ''), l.language_eng) AS language_name,			 
                ...
                LEFT JOIN sys_truckstogo_types su ON (su.id = a.id OR su.language_parent_id = a.id) AND su.deleted =0 AND su.active =0 AND lx.id = su.language_id
    ...
    /**
     * @author Okan CIRAN
     * @ sys_truckstogo_types tablosuna yeni bir kayıt oluşturur.  !!
     * @version v 1.0  05.05.2016
     * @param type $params
     * @return array
     * @throws \PDOException
        ...
        try {
            ...
            if (\Utill\Dal\Helper::haveRecord($opUserId)) {
                ...
                if (!\Utill\Dal\Helper::haveRecord($kontrol)) {
                    ...
                    $sql = "
                INSERT INTO sys_truckstogo_types(                        
                        name, 
                        name_eng, 
                        link, 
                        logo, 
                ...
                VALUES (
                    ...
                    $insertID = $pdo->lastInsertId('sys_truckstogo_types_id_seq');
                    $errorInfo = $statement->errorInfo();
                    if ($errorInfo[0] != "00000" && $errorInfo[1] != NULL && $errorInfo[2] != NULL)
                        throw new \PDOException($errorInfo[0]);
                    $pdo->commit();
    ...
    /**
     * @author Okan CIRAN
     * @ sys_truckstogo_types tablosunda property_name daha önce kaydedilmiş mi ?  
    ...
    /**
     * @author Okan CIRAN
     * sys_truckstogo_types tablosuna parametre olarak gelen id deki kaydın bilgilerini günceller   !!
     * @version v 1.0  05.05.2016
     * @param type $params
     * @return array
     * @throws \PDOException
    ...
    /**
     * @author Okan CIRAN
     * @ Gridi doldurmak için sys_truckstogo_types tablosundan kayıtları döndürür !!
     * @version v 1.0  05.05.2016
    ...
    /** 
     * @author Okan CIRAN
     * @ Gridi doldurmak için sys_truckstogo_types tablosundan çekilen kayıtlarının kaç tane olduğunu döndürür   !!
     * @version v 1.0  05.05.2016
     * @param array | null $args
     * @return array
     * @throws \PDOException
    ...
    /** 
     * @author Okan CIRAN
     * @ sosyal medya bilgilerini dropdown ya da tree ye doldurmak için sys_truckstogo_types tablosundan kayıtları döndürür !!
     * @version v 1.0  05.05.2016
     * @param array | null $args
     * @return array
     * @throws \PDOException 
     */
    public function truckstogoTypeDdList($params = array()) {
        try {
            $pdo = $this->slimApp->getServiceManager()->get('pgConnectFactory');         
		...
		LEFT JOIN sys_language lx ON lx.id =385 AND lx.deleted =0 AND lx.active =0   
                LEFT JOIN sys_truckstogo_types sd ON (sd.id =a.id OR sd.language_parent_id = a.id) AND sd.deleted =0 AND sd.active =0 AND lx.id = sd.language_id   
                WHERE                    
                    a.deleted = 0 AND

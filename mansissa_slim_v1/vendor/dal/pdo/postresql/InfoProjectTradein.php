 ...
 * @since 30.07.2018                         
 */ 
class InfoProjectTradein extends \DAL\DalSlim {

    /**
     * @author Okan CIRAN    
     * @ info_project_tradein tablosundan parametre olarak  gelen id kaydını siler. !!
    ...
    /**
     * @author Okan CIRAN
     * @ info_project_tradein tablosundaki tüm kayıtları getirir.  !!
     * @version v 1.0  30.07.2018  
     * @param array $params
     * @return array
     * @throws \PDOException 
    ...
    public function getAll($params = array()) {
        try {
			...
			COALESCE(NULLIF(lx.language, ''), l.language_eng) AS language_name,			 
                ...
                LEFT JOIN info_project_tradein ax ON (ax.id = a.id OR ax.language_parent_id = a.id) AND ax.deleted =0 AND ax.active =0 AND lx.id = ax.language_id
    ...
    /**
     * @author Okan CIRAN
     * @ info_project_tradein tablosuna yeni bir kayıt oluşturur.  !!
     * @version v 1.0  30.07.2018
     * @param type $params
     * @return array
     * @throws \PDOException
        ...
        try {
            ...
            if (\Utill\Dal\Helper::haveRecord($opUserId)) {
                ...
                //   echo debugPDO($sql, $params);
                    ...
                    $insertID = $pdo->lastInsertId('info_project_tradein_id_seq');
                    $errorInfo = $statement->errorInfo();  
                    if ($errorInfo[0] != "00000" && $errorInfo[1] != NULL && $errorInfo[2] != NULL)
                        throw new \PDOException($errorInfo[0]);
                    $pdo->commit();
    ...
    /**
     * @author Okan CIRAN
     * @ info_project_tradein tablosunda property_name daha önce kaydedilmiş mi ?  
    ...
    public function haveRecords($params = array()) {
        try {
            ...
            FROM info_project_tradein  a                          
            WHERE 
                a.project_id = " . intval($params['project_id']) . "  
                " . $addSql . " 
                AND a.deleted =5   
    ...
    /**
     * @author Okan CIRAN
     * info_project_tradein tablosuna parametre olarak gelen id deki kaydın bilgilerini günceller   !!
     * @version v 1.0  30.07.2018
     * @param type $params
     * @return array
     * @throws \PDOException
    ...
    /**
     * @author Okan CIRAN
     * @ Gridi doldurmak için info_project_tradein tablosundan kayıtları döndürür !!
     * @version v 1.0  30.07.2018
    ...
    /**
     * @author Okan CIRAN
     * @ Gridi doldurmak için info_project_tradein tablosundan çekilen kayıtlarının kaç tane olduğunu döndürür   !!
     * @version v 1.0  30.07.2018
     * @param array | null $args
     * @return array
     * @throws \PDOException
    ...
    /*
     * @author Okan CIRAN
     * @ info_project_tradein tablosundan parametre olarak  gelen id kaydın aktifliğini
    ...
    /** 
     * @author Okan CIRAN
     * @ deal  tradein tanımlarını grid formatında döndürür !! ana tablo  info_project_tradein 
     * @version v 1.0  20.08.2018
     * @param array | null $args 
     * @return array
     * @throws \PDOException  
     */  
    public function fillProjectTIGridx($params = array()) {
        try {
    ...
    /** 
     * @author Okan CIRAN
     * @ deal a eklenen trade in   grid formatında gösterilirken kaç kayıt olduğunu döndürür !! ana tablo info_project_tradein
     * @version v 1.0  20.08.2018
     * @param array | null $args
     * @return array
     * @throws \PDOException  
     */  
    public function fillProjectTIGridxRtl($params = array()) {
        try {             
            $sorguStr = null;    
            $addSQL = null;
            if (isset($params['filterRules'])) {
    ...
    /**
     * @author Okan CIRAN
     * @ info_project_tradein tablosundan parametre olarak  gelen id kaydını active ve show_it alanlarını 1 yapar. !!
    ...
    /**
     * @author Okan CIRAN     
     * @ info_project_tradein tablosundan parametre olarak  gelen id kaydın active veshow_it  alanını 1 yapar ve 
    ...
    public function insertAct($params = array()) {
        try {
            ...
            $Topused = null;
            if ((isset($params['Topused']) && $params['Topused'] != "")) {
                $Topused = $params['Topused'];
            } 
            $Customer= null;
            ...
            $OverAllowance = null;
            if ((isset($params['OverAllowance']) && $params['OverAllowance'] != "")) {
                $OverAllowance = $params['OverAllowance'];
            }              
            ...
            if (\Utill\Dal\Helper::haveRecord($opUserId)) {
                ...
                if (!\Utill\Dal\Helper::haveRecord($kontrol)) {
                    ...
                    VALUES ( 
                            ...
                            " . intval($opUserIdValue) . ",
                           (SELECT last_value FROM info_project_tradein_id_seq)
                                                 )   ";
                    $statement = $pdo->prepare($sql);
          //   echo debugPDO($sql, $params);
                    $result = $statement->execute();
    ...
    public function updateAct($params = array()) {
        try {
           ...
           $ProjectId = null;
            ...
            $OverAllowanceTypeId = null;
            if ((isset($params['OverAllowanceTypeId']) && $params['OverAllowanceTypeId'] != "")) {
                $OverAllowanceTypeId = $params['OverAllowanceTypeId'];
            } 

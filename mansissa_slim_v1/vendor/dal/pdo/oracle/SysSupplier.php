...
class SysSupplier extends \DAL\DalSlim {
    ...
    /** 
     * @author Okan CIRAN
     * @ uzun suplier tanımları dropdown ya da tree ye doldurmak için sys_acc_body_types tablosundan kayıtları döndürür !!
    ...
    public function  supplierLongDdList($params = array()) {
     ...
     /** 
     * @author Okan CIRAN
     * @ kısa suplier tanımları dropdown ya da tree ye doldurmak için sys_acc_body_types tablosundan kayıtları döndürür !!
     * @version v 1.0  11.08.2018
     * @param array | null $args
     * @return array
     * @throws \PDOException 

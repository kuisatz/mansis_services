 ...
 * @since 29.07.2018 
 */ 
class SysCurrencyFix extends \DAL\DalSlim {

    /**
     * @author Okan CIRAN
     * @ sys_currency_fix tablosundan parametre olarak  gelen id kaydını siler. !!
    ...
    /**
     * @author Okan CIRAN
     * @ sys_currency_fix tablosundaki tüm kayıtları getirir.  !!
     * @version v 1.0  29.07.2018  
     * @param array $params
     * @return array
     * @throws \PDOException 
    ...
    public function getAll($params = array()) {
        try {
			...
			COALESCE(NULLIF(lx.language, ''), l.language_eng) AS language_name,			 
                ...
                LEFT JOIN sys_currency_fix ax ON (ax.id = a.id OR ax.language_parent_id = a.id) AND ax.deleted =0 AND ax.active =0 AND lx.id = ax.language_id
    ...
    /**
     * @author Okan CIRAN
     * @ sys_currency_fix tablosunda property_name daha önce kaydedilmiş mi ?  
    ...
    /**
     * @author Okan CIRAN
     * sys_currency_fix tablosuna parametre olarak gelen id deki kaydın bilgilerini günceller   !!
     * @version v 1.0  29.07.2018
     * @param type $params
     * @return array
     * @throws \PDOException
    ...
    /**
     * @author Okan CIRAN
     * @ Gridi doldurmak için sys_currency_fix tablosundan kayıtları döndürür !!
     * @version v 1.0  29.07.2018
    ...
    /**
     * @author Okan CIRAN
     * @ Gridi doldurmak için sys_currency_fix tablosundan çekilen kayıtlarının kaç tane olduğunu döndürür   !!
     * @version v 1.0  29.07.2018
     * @param array | null $args
     * @return array
     * @throws \PDOException
    ...
    /*
     * @author Okan CIRAN
     * @ sys_currency_fix tablosundan parametre olarak  gelen id kaydın aktifliğini
    ...
    public function fillCurrencyFixGridx($params = array()) {
        try {
            ...
            if (isset($params['CurrencyID']) && $params['CurrencyID'] != "") {
                ...
                $addSql ="  a.currency_id  = " . intval($currencyID). "  AND  " ; 
            }  
			...
			a.fix, 
                    ...
                    INNER JOIN info_users u ON u.id = a.op_user_id 
                    /*----*/ 
		    INNER JOIN sys_currency_types ct ON  ct.act_parent_id = a.currency_id AND ct.show_it = 0 AND ct.language_id = l.id 
    ...
    /** 
     * @author Okan CIRAN
     * @ Tarih Bazlı Döviz kur bilgileri grid formatında gösterilirken kaç kayıt olduğunu döndürür !! ana tablo  sys_currency_fix 
     * @version v 1.0  20.08.2018
     * @param array | null $args
     * @return array
     * @throws \PDOException  
            ...
            if (isset($params['CurrencyID']) && $params['CurrencyID'] != "") {
                ...
                $sql = "
                   SELECT COUNT(asdx.id) count FROM ( 
                        ...
                        INNER JOIN info_users u ON u.id = a.op_user_id 
                        /*----*/ 
                        INNER JOIN sys_currency_types ct ON  ct.act_parent_id = a.currency_id AND ct.deleted = 0 AND ct.active = 0 AND ct.language_id = l.id 
                        LEFT JOIN sys_currency_types ctx ON (ctx.act_parent_id = ct.act_parent_id OR ctx.language_parent_id = ct.act_parent_id) AND ctx.deleted = 0 AND ctx.active = 0 AND ctx.language_id = lx.id
    ...
    /**
     * @author Okan CIRAN     
     * @ sys_currency_fix tablosundan parametre olarak  gelen id kaydın active veshow_it  alanını 1 yapar ve 

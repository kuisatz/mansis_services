 ...
 * @since 30.07.2018   
 */ 
class SysMileagesx extends \DAL\DalSlim {

    /**
     * @author Okan CIRAN
     * @ sys_mileagesx tablosundan parametre olarak  gelen id kaydını siler. !!
     * @version v 1.0  29.08.2018
     * @param array $params
     * @return array
     * @throws \PDOException
     */
    ...
    /**
     * @author Okan CIRAN
     * @ sys_mileagesx tablosundaki tüm kayıtları getirir.  !!
    ...
    public function getAll($params = array()) {
        try {
			...
			COALESCE(NULLIF(lx.language, ''), l.language_eng) AS language_name,			 
                ...
                LEFT JOIN sys_mileagesx ax ON (ax.id = a.id OR ax.language_parent_id = a.id) AND ax.deleted =0 AND ax.active =0 AND lx.id = ax.language_id
    ...
    /**
     * @author Okan CIRAN
     * @ sys_mileagesx tablosunda property_name daha önce kaydedilmiş mi ?  
    ...
    /**
     * @author Okan CIRAN
     * sys_mileagesx tablosuna parametre olarak gelen id deki kaydın bilgilerini günceller   !!
     * @version v 1.0  30.07.2018
     * @param type $params
     * @return array
     * @throws \PDOException
    ...
    /**
     * @author Okan CIRAN
     * @ Gridi doldurmak için sys_mileagesx tablosundan kayıtları döndürür !!
     * @version v 1.0  30.07.2018
    ...
    /**
     * @author Okan CIRAN
     * @ Gridi doldurmak için sys_mileagesx tablosundan çekilen kayıtlarının kaç tane olduğunu döndürür   !!
     * @version v 1.0  30.07.2018
     * @param array | null $args
     * @return array
     * @throws \PDOException
    ...
    /*
     * @author Okan CIRAN
     * @ sys_mileagesx tablosundan parametre olarak  gelen id kaydın aktifliğini
    ...
    /** 
     * @author Okan CIRAN
     * @ kilometre tipleri ana grupları dropdown ya da tree ye doldurmak için sys_mileagesx tablosundan kayıtları döndürür !!
    ...
    /** 
     * @author Okan CIRAN
     * @ kilometre tipleri alt grupları dropdown ya da tree ye doldurmak için sys_mileagesx tablosundan kayıtları döndürür !!
     * @version v 1.0  11.08.2018
     * @param array | null $args
     * @return array
     * @throws \PDOException 
    ...
    public function  mileagesParentDdList($params = array()) {
		...
		LEFT JOIN sys_language lx ON lx.id = " . intval($languageIdValue). "  AND lx.deleted =0 AND lx.active =0                      		
                ...
                SELECT                    
                    a.act_parent_id AS id, 	
                    cast(mileages1 as character varying(20)) AS name,  
                    cast(mileages2 as character varying(20)) AS name_eng,
                    a.parent_id,
                    a.active,
                    0 AS state_type ,
                    a.priority
    ...
    /** 
     * @author Okan CIRAN
     * @ R&M kilometre tipleri alt grupları dropdown ya da tree ye doldurmak için sys_mileagesx tablosundan kayıtları döndürür !!
     * @version v 1.0  11.08.2018
     * @param array | null $args
     * @return array
     * @throws \PDOException 
    ...
    /** 
     * @author Okan CIRAN
     * @ Buyback kilometre tipleri alt grupları dropdown ya da tree ye doldurmak için sys_mileagesx tablosundan kayıtları döndürür !!
     * @version v 1.0  11.08.2018
     * @param array | null $args
     * @return array
     * @throws \PDOException 
    ...
    /** 
     * @author Okan CIRAN
     * @ Warranty kilometre tipleri alt grupları dropdown ya da tree ye doldurmak için sys_mileagesx tablosundan kayıtları döndürür !!
     * @version v 1.0  11.08.2018
     * @param array | null $args
     * @return array
     * @throws \PDOException 
    ...
    /** 
     * @author Okan CIRAN
     * @ kilometre tipleri tanımlarını grid formatında döndürür !! ana tablo  sys_mileagesx 
    ...
    public function fillMileagesGridx($params = array()) {
        try {
                    ...
                    if ($std['value'] != null) {
                        switch (trim($std['field'])) {
                            case 'name':
                                ...
                                $sorguStr.=" AND cast(a.mileages1 as character varying(20)))" . $sorguExpression . ' ';
			...
			a.parent_id,  
                    ...
                    INNER JOIN info_users u ON u.id = a.op_user_id 
                    /*----*/   
		    INNER JOIN sys_mileagesx drd ON drd.act_parent_id = a.parent_id AND drd.active =0 AND drd.deleted = 0 AND drd.language_id= l.id and drd.parent_id =0 
		    LEFT JOIN sys_mileagesx drdx ON (drdx.act_parent_id = drd.act_parent_id OR drdx.language_parent_id= drd.act_parent_id) AND drdx.active =0 AND drdx.deleted = 0 AND drdx.language_id =lx.id  
                    /*----*/   
    ...
    /** 
     * @author Okan CIRAN
     * @ kilometre tipleri tanımlarını grid formatında gösterilirken kaç kayıt olduğunu döndürür !! ana tablo sys_mileagesx
     * @version v 1.0  20.08.2018
     * @param array | null $args
     * @return array
     * @throws \PDOException  
    ...
    public function fillMileagesGridxRtl($params = array()) {
        ...
        /**
     * @author Okan CIRAN
     * @ sys_mileagesx tablosundan parametre olarak  gelen id kaydını active ve show_it alanlarını 1 yapar. !!
    ...
    /**
     * @author Okan CIRAN     
     * @ sys_mileagesx tablosundan parametre olarak  gelen id kaydın active veshow_it  alanını 1 yapar ve 
    ...
    /**
     * @author Okan CIRAN
     * @ sys_mileages tablosuna yeni bir kayıt oluşturur.  !! 
            ...
            if (\Utill\Dal\Helper::haveRecord($opUserId)) {
                ...
                if (!\Utill\Dal\Helper::haveRecord($kontrol)) {
                    ...
                    VALUES (
                            ...
                            " . intval($mileages1) . ",
                            " . intval($mileages2) . ",
                            ( SELECT cz.type_id FROM sys_mileages cz WHERE cz.id =  " . intval($parentId) . " ) type_id, 

                            " . intval($opUserIdValue) . ",
                           (SELECT last_value FROM sys_mileages_id_seq)
                                                 )   ";
                    $statement = $pdo->prepare($sql);
                    //   echo debugPDO($sql, $params);
                    $result = $statement->execute();
                    ...
                    if ($errorInfo[0] != "00000" && $errorInfo[1] != NULL && $errorInfo[2] != NULL)
                        throw new \PDOException($errorInfo[0]);
                    $insertID = $pdo->lastInsertId('sys_mileages_id_seq');
    ...
    /**
     * @author Okan CIRAN
     * sys_mileages tablosuna parametre olarak gelen id deki kaydın bilgilerini günceller   !!
     * @version v 1.0  26.08.2018
     * @param type $params
     * @return array
     * @throws \PDOException

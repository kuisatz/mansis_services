 ...
 * @since 29.07.2018  
 */ 
class SysAccessoriesMatrix extends \DAL\DalSlim {

    /**
     * @author Okan CIRAN
     * @ sys_accessories_matrix tablosundan parametre olarak  gelen id kaydını siler. !!
    ...
    /**
     * @author Okan CIRAN
     * @ sys_accessories_matrix tablosundaki tüm kayıtları getirir.  !!
     * @version v 1.0  29.07.2018  
     * @param array $params
     * @return array
     * @throws \PDOException 
    ...
    public function getAll($params = array()) {
        try {
			...
			COALESCE(NULLIF(lx.language, ''), l.language_eng) AS language_name,			 
                ...
                LEFT JOIN sys_accessories_matrix ax ON (ax.id = a.id OR ax.language_parent_id = a.id) AND ax.deleted =0 AND ax.active =0 AND lx.id = ax.language_id
    ...
    /**
     * @author Okan CIRAN
     * @ sys_accessories_matrix tablosunda property_name daha önce kaydedilmiş mi ?  
    ...
    /**
     * @author Okan CIRAN
     * @ Gridi doldurmak için sys_accessories_matrix tablosundan kayıtları döndürür !!
     * @version v 1.0  29.07.2018
    ...
    /**
     * @author Okan CIRAN
     * @ Gridi doldurmak için sys_accessories_matrix tablosundan çekilen kayıtlarının kaç tane olduğunu döndürür   !!
     * @version v 1.0  29.07.2018
     * @param array | null $args
     * @return array
     * @throws \PDOException
    ...
    /*
     * @author Okan CIRAN
     * @ sys_accessories_matrix tablosundan parametre olarak  gelen id kaydın aktifliğini
                    ...
                    if ($std['value'] != null) {
                        switch (trim($std['field'])) {
                            case 'vehicle_group':
                             ...
                             case 'kp':
                                $sorguExpression = ' ILIKE \'%' . $std['value'] . '%\' ';
                                $sorguStr.=" AND k.name" . $sorguExpression . ' ';
            ...
            if (isset($params['SupplierID']) && $params['SupplierID'] != "") {
                ...
                $sql = "
                   SELECT COUNT(asdx.id) count FROM ( 
                        ...
                        INNER JOIN sys_accessory_options ap on ap.act_parent_id = asm.accessory_option_id and ap.deleted =0 AND ap.active = 0 AND ap.language_id = l.id
                        LEFT JOIN sys_accessory_options apx ON (apx.act_parent_id = ap.act_parent_id OR apx.language_parent_id = ap.act_parent_id) AND apx.deleted = 0 AND apx.active = 0 AND apx.language_id = lx.id  

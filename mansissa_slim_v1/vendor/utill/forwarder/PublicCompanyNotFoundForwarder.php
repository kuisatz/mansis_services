...
class PublicCompanyNotFoundForwarder extends \Utill\Forwarder\AbstractForwarder {
    ...
    public  function redirect() {
        ...
        $ch = curl_init('http://localhost/mansis_services/mansissa_Slim_Redirect_v12/index.php/publicCompanyNotFound?test='.  serialize($this->parameters).'&test2='.$_SERVER['REMOTE_ADDR'].'');

 ...
 */
class SysTonnage extends \BLL\BLLSlim{
    ...
    public function insert($params = array()) {
        $DAL = $this->slimApp->getDALManager()->get('sysTonnagePostgrePDO');
    ...
    */
    public function tonnageDdList($params = array()) {
        $DAL = $this->slimApp->getDALManager()->get('sysTonnagePostgrePDO');
        $resultSet = $DAL->tonnageDdList($params);
        return $resultSet['resultSet'];
    } 
    ...
    public function fillTonnageGridx ($params = array()) { 
        $DAL = $this->slimApp->getDALManager()->get('sysTonnagePostgrePDO');
        $resultSet = $DAL->fillTonnageGridx($params);  
        return $resultSet['resultSet'];
    }

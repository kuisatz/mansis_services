 ...
 */
class InfoProjectTradeback  extends \BLL\BLLSlim{
    ...
    public function insert($params = array()) {
        $DAL = $this->slimApp->getDALManager()->get('infoProjectTradebackPostgrePDO');
    ...
    */
    public function projectVehicleTBDdList($params = array()) {
        $DAL = $this->slimApp->getDALManager()->get('infoProjectTradebackPostgrePDO');
        $resultSet = $DAL->projectVehicleTBDdList($params);
        return $resultSet['resultSet'];
    }
    ...
    */
    ...
    public function fillProjectVehicleTBGridx ($params = array()) { 
        $DAL = $this->slimApp->getDALManager()->get('infoProjectTradebackPostgrePDO');
        $resultSet = $DAL->fillProjectVehicleTBGridx($params);  
        return $resultSet['resultSet'];
    }
    ...
    public function fillProjectVehicleTBGridxRtl($params = array()) {
        $DAL = $this->slimApp->getDALManager()->get('infoProjectTradebackPostgrePDO');
        $resultSet = $DAL->fillProjectVehicleTBGridxRtl($params);  
        return $resultSet['resultSet'];
    }

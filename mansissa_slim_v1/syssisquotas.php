 ...
 * @since 15-08-2018
 */
$app->get("/pkFillSisQuotasGridx_syssisquotas/", function () use ($app ) {
    $stripper = $app->getServiceManager()->get('filterChainerCustom');
    $stripChainerFactory = new \Services\Filter\Helper\FilterChainerFactory();
    $BLL = $app->getBLLManager()->get('sysSisQuotasBLL');
    $headerParams = $app->request()->headers();
    if (!isset($headerParams['X-Public']))
        throw new Exception('rest api "pkFillSisQuotasGridx_syssisquotas" end point, X-Public variable not found');
    ...
    $resDataGrid = $BLL->fillSisQuotasGridx(array(
    ...
    $resTotalRowCount = $BLL->fillSisQuotasGridxRtl(array(
        'language_code' => $vLanguageCode, 
        'LanguageID' => $lid,

 ...
 * @since 15-08-2018
 */
$app->get("/pkBranchesDealersDeffDdList_sysbranchesdealersdeff/", function () use ($app ) {
    ...
    if(!isset($headerParams['X-Public'])) throw new Exception ('rest api "pkBranchesDealersDeffDdList_sysbranchesdealersdeff" end point, X-Public variable not found');
    ...
    $resCombobox = $BLL->branchesDealersDeffDdList(array(                                   
...
$app->get("/pkFillAccBodyDeffGridx_sysbranchesdealersdeff/", function () use ($app ) {
    ...
    if (!isset($headerParams['X-Public']))
        throw new Exception('rest api "pkFillAccBodyDeffGridx_sysbranchesdealersdeff" end point, X-Public variable not found');
    $pk = $headerParams['X-Public'];
        ...
        foreach ($resDataGrid as $menu) {
            $menus[] = array(
               "id" => $menu["id"],
                ...
                "branch_no" => html_entity_decode($menu["branch_no"]),   
                ...
                "departman_name" => html_entity_decode($menu["departman_name"]),  
                "country_id" =>  ($menu["country_id"]),   
                "country_region_id" =>  ($menu["country_region_id"]),   
                "city_id" =>  ($menu["city_id"]),   
                "sis_department_id" =>  ($menu["sis_department_id"]),   
 ...
 * @since 15-08-2018
 */
$app->get("/pkUpdateMakeActiveOrPassive_sysbranchesdealersdeff/", function () use ($app ) {
 ...
 * @since 15-08-2018
 */ 
$app->get("/pkInsertAct_sysbranchesdealersdeff/", function () use ($app ) {
    $stripper = $app->getServiceManager()->get('filterChainerCustom');
    $stripChainerFactory = new \Services\Filter\Helper\FilterChainerFactory(); 
    $BLL = $app->getBLLManager()->get('sysBranchesDealersDeffBLL');  
    $headerParams = $app->request()->headers();
    if(!isset($headerParams['X-Public'])) throw new Exception ('rest api "pkInsertAct_sysbranchesdealersdeff" end point, X-Public variable not found');    
     $pk =  $headerParams['X-Public'];
 ...
 * @since 15-08-2018
 */ 
$app->get("/pkUpdateAct_sysbranchesdealersdeff/", function () use ($app ) {
    $stripper = $app->getServiceManager()->get('filterChainerCustom');
    $stripChainerFactory = new \Services\Filter\Helper\FilterChainerFactory(); 
    $BLL = $app->getBLLManager()->get('sysBranchesDealersDeffBLL');  
    $headerParams = $app->request()->headers();
    if(!isset($headerParams['X-Public'])) throw new Exception ('rest api "pkUpdateAct_sysbranchesdealersdeff" end point, X-Public variable not found');    
    $pk = $headerParams['X-Public'];
 ...
 * @since 15-08-2018
 */
$app->get("/pkDeletedAct_sysbranchesdealersdeff/", function () use ($app ) {
    $stripper = $app->getServiceManager()->get('filterChainerCustom');
    $stripChainerFactory = new \Services\Filter\Helper\FilterChainerFactory();    
    $BLL = $app->getBLLManager()->get('sysBranchesDealersDeffBLL');   
    $headerParams = $app->request()->headers();

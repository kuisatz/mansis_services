 ...
 * @since 11.08.2018
 */
$app->get("/pkBuybackMonthsDdList_sysmonths/", function () use ($app ) {
    $stripper = $app->getServiceManager()->get('filterChainerCustom');
    $stripChainerFactory = new \Services\Filter\Helper\FilterChainerFactory(); 
    $BLL = $app->getBLLManager()->get('sysMonthsBLL');
    ...
    $headerParams = $app->request()->headers();
    if(!isset($headerParams['X-Public'])) throw new Exception ('rest api "pkBuybackMonthsDdList_sysmonths" end point, X-Public variable not found');
    //$pk = $headerParams['X-Public'];
    ...
    $resCombobox = $BLL->BuybackMonthsDdList(array(                                   
                                    'language_code' => $vLanguageCode,
                                    'LanguageID' => $lid,
                        ));    
 ...
 * @since 11.08.2018
 */
$app->get("/pkJustYearsDdList_sysmonths/", function () use ($app ) {
    $stripper = $app->getServiceManager()->get('filterChainerCustom');
    $stripChainerFactory = new \Services\Filter\Helper\FilterChainerFactory(); 
    $BLL = $app->getBLLManager()->get('sysMonthsBLL');
    ...
    $headerParams = $app->request()->headers();
    if(!isset($headerParams['X-Public'])) throw new Exception ('rest api "pkJustYearsDdList_sysmonths" end point, X-Public variable not found');
    //$pk = $headerParams['X-Public'];
    ...
    $resCombobox = $BLL->justYearsDdList(array(                                   
                                    'language_code' => $vLanguageCode,
                                    'LanguageID' => $lid,
                        ));    

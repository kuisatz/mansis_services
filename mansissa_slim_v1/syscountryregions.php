 ...
 * @since 11.08.2018
 */
$app->get("/pkCountryRegionsDdList_syscountryregions/", function () use ($app ) {
    $stripper = $app->getServiceManager()->get('filterChainerCustom');
    $stripChainerFactory = new \Services\Filter\Helper\FilterChainerFactory(); 
    $BLL = $app->getBLLManager()->get('sysCountryRegionsBLL');
    ...
    if(!isset($headerParams['X-Public'])) throw new Exception ('rest api "pkCountryRegionsDdList_syscountryregions" end point, X-Public variable not found');

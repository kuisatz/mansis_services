 ...
 * @since 20.08.2018
 */
$app->get("/pkVehiclesTbDefDdList_sysvehiclestrade/", function () use ($app ) {
    ...
    if(!isset($headerParams['X-Public'])) throw new Exception ('rest api "pkVehiclesTbDefDdList_sysvehiclestrade" end point, X-Public variable not found');
    ...
    if($stripper->offsetExists('vehicle_gt_model_id')) $VehicleGroupTypesId = $stripper->offsetGet('vehicle_gt_model_id')->getFilterValue();
        
    $resCombobox = $BLL->vehiclesTbDefDdList(array(                                   
 ...
 * @since 20.08.2018
 */
 $app->get("/pkVehiclesBbDefDdList_sysvehiclestrade/", function () use ($app ) {
    $stripper = $app->getServiceManager()->get('filterChainerCustom');
    $stripChainerFactory = new \Services\Filter\Helper\FilterChainerFactory(); 
    $BLL = $app->getBLLManager()->get('sysVehiclesTradeBLL');
    ...
    $headerParams = $app->request()->headers();
    if(!isset($headerParams['X-Public'])) throw new Exception ('rest api "pkVehiclesBbDefDdList_sysvehiclestrade" end point, X-Public variable not found');
    //$pk = $headerParams['X-Public'];
    ...
    $resCombobox = $BLL->vehiclesBbDefDdList(array(                                   
                                    'language_code' => $vLanguageCode,
                                    'VehicleGtModelId' => $VehicleGroupTypesId,
                                    'LanguageID' => $lid,
                        ));    
 ...
 * @since 15-08-2018
 */
$app->get("/pkFillVehiclesTradeNamesGridx_sysvehiclestrade/", function () use ($app ) {
    $stripper = $app->getServiceManager()->get('filterChainerCustom');
    $stripChainerFactory = new \Services\Filter\Helper\FilterChainerFactory();
    $BLL = $app->getBLLManager()->get('sysVehiclesTradeBLL');
    $headerParams = $app->request()->headers();
    ...
    $resDataGrid = $BLL->fillVehiclesTradeNamesGridx(array(
        'language_code' => $vLanguageCode,
        'LanguageID' => $lid,
        'page' => $vPage,
        'rows' => $vRows,
 ...
 * @since 15-08-2018
 */
$app->get("/pkUpdateMakeActiveOrPassive_sysvehiclestrade/", function () use ($app ) {
 ...
 * @since 15-08-2018
 */ 
$app->get("/pkInsertAct_sysvehiclestrade/", function () use ($app ) {
    $stripper = $app->getServiceManager()->get('filterChainerCustom');
    $stripChainerFactory = new \Services\Filter\Helper\FilterChainerFactory(); 
    $BLL = $app->getBLLManager()->get('sysVehiclesTradeBLL');  
    $headerParams = $app->request()->headers();
    if(!isset($headerParams['X-Public'])) throw new Exception ('rest api "pkInsertAct_sysvehiclestrade" end point, X-Public variable not found');    
     $pk =  $headerParams['X-Public'];
 ...
 * @since 15-08-2018
 */ 
$app->get("/pkUpdateAct_sysvehiclestrade/", function () use ($app ) {
    $stripper = $app->getServiceManager()->get('filterChainerCustom');
    $stripChainerFactory = new \Services\Filter\Helper\FilterChainerFactory(); 
    $BLL = $app->getBLLManager()->get('sysVehiclesTradeBLL');  
    $headerParams = $app->request()->headers();
    if(!isset($headerParams['X-Public'])) throw new Exception ('rest api "pkUpdateAct_sysvehiclestrade" end point, X-Public variable not found');    
    $pk = $headerParams['X-Public'];
 ...
 * @since 15-08-2018
 */
$app->get("/pkDeletedAct_sysvehiclestrade/", function () use ($app ) {
    $stripper = $app->getServiceManager()->get('filterChainerCustom');
    $stripChainerFactory = new \Services\Filter\Helper\FilterChainerFactory();    
    $BLL = $app->getBLLManager()->get('sysVehiclesTradeBLL');   
    $headerParams = $app->request()->headers();

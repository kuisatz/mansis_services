 ...
 * @since 05.05.2016
 */
$app->get("/pkBuybackTypesDdList_sysbuybackmatrix/", function () use ($app ) {
    ...
    if(!isset($headerParams['X-Public'])) throw new Exception ('rest api "pkBuybackTypesDdList_sysbuybackmatrix" end point, X-Public variable not found');
    ...
    $resCombobox = $BLL->buybackTypesDdList(array(                                   
 ...
 * @since 15-08-2018
 */
$app->get("/pkFillBuybackTradeBackMatrixGridx_sysbuybackmatrix/", function () use ($app ) {
    $stripper = $app->getServiceManager()->get('filterChainerCustom');
    $stripChainerFactory = new \Services\Filter\Helper\FilterChainerFactory();
    $BLL = $app->getBLLManager()->get('sysBuybackMatrixBLL');
    $headerParams = $app->request()->headers();
    if (!isset($headerParams['X-Public']))
        throw new Exception('rest api "pkFillBuybackTradeBackMatrixGridx_sysbuybackmatrix" end point, X-Public variable not found');
    $pk = $headerParams['X-Public'];
    ...
    $resDataGrid = $BLL->fillBuybackTradeBackMatrixGridx(array(
        'language_code' => $vLanguageCode,
        'LanguageID' => $lid,
        'page' => $vPage,
        'rows' => $vRows,
    ...
    $resTotalRowCount = $BLL->fillBuybackTradeBackMatrixGridxRtl(array(
        'language_code' => $vLanguageCode, 
        'LanguageID' => $lid,
 ...
 * @since 15-08-2018
 */ 
$app->get("/pkInsertAct_sysbuybackmatrix/", function () use ($app ) {
    $stripper = $app->getServiceManager()->get('filterChainerCustom');
    $stripChainerFactory = new \Services\Filter\Helper\FilterChainerFactory(); 
    $BLL = $app->getBLLManager()->get('sysBuybackMatrixBLL');  
    $headerParams = $app->request()->headers();
 ...
 * @since 15-08-2018
 */ 
$app->get("/pkUpdateAct_sysbuybackmatrix/", function () use ($app ) {
    $stripper = $app->getServiceManager()->get('filterChainerCustom');
    $stripChainerFactory = new \Services\Filter\Helper\FilterChainerFactory(); 
    $BLL = $app->getBLLManager()->get('sysBuybackMatrixBLL');  
    $headerParams = $app->request()->headers();

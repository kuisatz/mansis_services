...
$app->get("/pkFillDepartmentsTree_syssisdepartments/", function () use ($app ) {
    ...
    if(!isset($headerParams['X-Public'])) throw new Exception ('rest api "pkFillDepartmentsTree_syssisdepartments" end point, X-Public variable not found');
    ...
    $resCombobox = $BLL->fillDepartmentsTree(array(                                   
